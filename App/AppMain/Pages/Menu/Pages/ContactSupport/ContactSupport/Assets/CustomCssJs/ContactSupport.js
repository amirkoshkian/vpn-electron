...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let ButtonGoToPagePrivacyPolicy = document.querySelector(".section-text-support-center");
    let ButtonGoToPageTermsOfService = document.querySelector(".section-text-send-email");
